...
> focus return).
> **Not yet done**: elm-review config (CI lints via grep instead), isolated
> preview mode (dim-only, 6.1), views-catalog round-trip walk (6.2), task 7.1
> cabal-regenerated fixtures, and the live-server conformance pass (6.2/7.2).
