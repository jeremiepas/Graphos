...
The module SHALL export `data Resolution = Resolution { resGamma :: !Double, resMinSize :: !Int, resMergeInto :: !MergeStrategy, resMaxIterations :: !Int }` with `defaultResolution = Resolution { resGamma = 1.0, resMinSize = 3, resMergeInto = MergeToNeighbor, resMaxIterations = 50 }`. The system SHALL auto-tune by graph size: `<1k` → gamma=1.0/minSize=3/maxIter=50; `1k–10k` → 0.8/5/30; `10k–100k` → 0.5/10/20; `100k+` → 0.3–0.5/10–20/10–20. (PRD §5.2, §5.3)
