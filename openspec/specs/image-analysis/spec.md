...
Extract structured knowledge from image files using multimodal LLM analysis, producing graph nodes for images, their descriptions, classifications, and extracted entities.
