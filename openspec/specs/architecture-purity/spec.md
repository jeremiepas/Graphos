# Architecture Purity Capability

## Purpose

Enforce clean architecture layering: the Domain layer remains pure and independent of Infrastructure concerns. Domain modules must not import Infrastructure modules, and shared configuration types must be defined in Domain.
