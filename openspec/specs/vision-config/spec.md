# Vision Configuration Capability

## Purpose

Configure multimodal LLM vision analysis for image extraction, supporting any OpenAI-compatible API with configurable model, API key, base URL, and batch size.
