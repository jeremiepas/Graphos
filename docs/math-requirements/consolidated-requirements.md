...
- **No silently dropped requirement:** all 12 GT + 4 GT-W + 12 CT + 3 JOINT rows appear in §1; every acceptance test in §2 references a register ID.
